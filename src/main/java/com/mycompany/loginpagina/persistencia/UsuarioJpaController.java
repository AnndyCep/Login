...
public class UsuarioJpaController implements Serializable {
    ...
    public void create(Usuario usuario) {
        ...
        try {
            ...
            if (unRol != null) {
                unRol = em.getReference(unRol.getClass(), unRol.getId_rol());
    ...
    public void edit(Usuario usuario) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Usuario persistentUsuario = em.find(Usuario.class, usuario.getId_usser());
            Rol unRolOld = persistentUsuario.getUnRol();
            Rol unRolNew = usuario.getUnRol();
            if (unRolNew != null) {
                unRolNew = em.getReference(unRolNew.getClass(), unRolNew.getId_rol());
